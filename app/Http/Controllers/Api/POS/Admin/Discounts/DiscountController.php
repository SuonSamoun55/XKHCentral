...
class DiscountController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('POSViews.POSAdminViews.Discounts.index', compact('items'));
    }
 ...
 public function create()
{
    ...
    return view('POSViews.POSAdminViews.Discounts.create', compact('items', 'categories', 'discountItemsJson'));
}
