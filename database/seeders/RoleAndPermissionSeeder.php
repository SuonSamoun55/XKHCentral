...
class RoleAndPermissionSeeder extends Seeder
{
    ...
    public static array $pages = [
        ...
        'number_series' => ['label' => 'Number Series', 'group' => 'admin', 'urls' => '/number-series/*'],
        'vat_posting_setup' => ['label' => 'VAT Posting Setup', 'group' => 'admin', 'urls' => '/vat-posting-setup/*'],
        'report_settings' => ['label' => 'Report Settings', 'group' => 'admin', 'urls' => '/report-settings/*'],
        'approval_entries' => ['label' => 'Approval Entries', 'group' => 'admin', 'urls' => '/approval-entries/*'],
