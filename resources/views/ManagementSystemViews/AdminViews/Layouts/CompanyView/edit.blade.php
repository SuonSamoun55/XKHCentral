                ...
                <div class="logo-panel">
                    <div class="logo-avatar-wrap">
                        <div class="logo-circle">
                            ...
                            <img id="logoPreview" src="{{ !empty($company->logo) ? asset('storage/' . $company->logo) : '' }}" alt="Logo Preview" style="{{ empty($company->logo) ? 'display:none;' : '' }}">
                        </div>
                ...
                <div class="form-panel">
                    ...
                    <div class="form-section">
                        ...
                        <div class="field-row">
                            ...
                            <div class="field">
                                <label>Contact</label>
                                <input type="text" name="phone" value="{{ old('phone', $company->phone) }}" placeholder="+855">
                            </div>
                        </div>
                    ...
                    <div class="form-section">
                        ...
                        <div class="field-row">
                            <div class="field">
                                ...
                                <input type="text" name="client_id" value="{{ old('client_id', $company->companyConnection->client_id ?? '') }}" required>
                            </div>
                            <div class="field">
                                <label>BC Company ID</label>
                                <input type="text" name="company_bc_id" value="{{ old('company_bc_id', $company->companyConnection->company_bc_id ?? '') }}" required>
                            </div>
                        </div>
                        ...
                        <div class="field-row single">
                            <div class="field">
                                ...
                                <input type="text" name="tenant_id" value="{{ old('tenant_id', $company->companyConnection->tenant_id ?? '') }}" required>
                            </div>
                        </div>
                        ...
                        <div class="field-row single">
                            <div class="field">
                                ...
                                <input type="text" name="client_secret" value="" placeholder="Leave blank to keep current secret">
                            </div>
                        </div>
                        ...
                        <div class="field-row">
                            <div class="field">
                                ...
                                <input type="text" name="environment" value="{{ old('environment', $company->companyConnection->environment ?? '') }}">
                            </div>
                            <div class="field">
                                <label>Connection Status</label>
                                <select name="status">
                                    <option value="1" {{ old('status', $company->companyConnection->status ?? false) ? 'selected' : '' }}>Active</option>
                                    <option value="0" {{ !old('status', $company->companyConnection->status ?? false) ? 'selected' : '' }}>Inactive</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="field-row single">
                            <div class="field">
                                ...
                                <input type="text" name="base_url" value="{{ old('base_url', $company->companyConnection->base_url ?? '') }}">
                            </div>
                        </div>
                        ...
                        <div class="field-row single">
                            <div class="field">
                                ...
                                <input type="text" name="token_url" value="{{ old('token_url', $company->companyConnection->token_url ?? '') }}">
                            </div>
                        </div>
                    </div>
