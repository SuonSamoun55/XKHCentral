...
<div class="role-form-page">
    ...
    <div class="page-head">
        <h1>Edit Role</h1>
        <p>Update what this role is called and which pages it can reach.</p>
    </div>
            ...
            <div class="top-row">
                <div class="field-card">
                    <div class="field">
                        ...
                        <input type="text" name="name" id="roleName" placeholder="e.g. support" value="{{ old('name', $role->name) }}" required>
                        <div class="field-hint">Internal key used in code — lowercase, no spaces.</div>
                    </div>
                    <div class="field">
                        <label for="displayName">Display Name</label>
                        <input type="text" name="display_name" id="displayName" placeholder="e.g. Chat Support" value="{{ old('display_name', $role->display_name) }}">
                    ...
                    @if (auth()->user()?->canManageStaffAcrossCompanies())
                        <div class="field">
                            <label class="cross-company-check">
                                <input type="checkbox" name="is_cross_company" id="isCrossCompany" value="1" {{ old('is_cross_company', $role->is_cross_company) ? 'checked' : '' }}>
