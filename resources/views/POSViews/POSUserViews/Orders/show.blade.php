...
@section('content')
    ...
    <div id="order-detail-page">
            ...
            @forelse ($order->items as $line)
                @php
                    ...
                    $variantLabel = optional($line->itemVariant)->description
                        ...
                        ?? null;
                    $unitLabel = strtoupper(optional($line->item)->base_unit_of_measure_code ?? '');
                @endphp
        ...
        <div class="od-mobile-actions">
            <a href="{{ route('orders.report.preview', $order->id) }}" class="od-mobile-download-btn">
                View Report <i class="bi bi-file-earmark-pdf"></i>
            </a>
        ...
        <div class="od-header">
            ...
            <div class="od-header-actions">
                <a href="{{ route('orders.report.preview', $order->id) }}" class="od-download-btn">
                    View Report <i class="bi bi-file-earmark-pdf"></i>
                </a>
                ...
                <div class="od-table-card-body od-table-wrap">
                    <table class="od-table">
                        ...
                        <tbody>
                            ...
                            @empty
                                <tr>
                                    <td colspan="8" style="text-align:center; padding: 28px 0; color:#64748b;">
